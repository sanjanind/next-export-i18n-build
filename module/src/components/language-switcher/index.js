...
const LanguageSwitcher = ({ lang, children, shallow = false }) => {
    ...
    if (React.isValidElement(children)) {
        ...
        return (React.createElement("span", { role: "button", "aria-label": `set language to ${lang}`, "data-language-switcher": "true", "data-is-current": languageSwitcherIsActive, onClick: () => {
                // set the language
                updateRouter();
            } }, children));
    }
